...
import TeacherAddNewRescheduleForm from "../components/TeacherAddNewRescheduleForm";
import CourseMenuBar from "../components/course_menu_bar";

const TeacherAddNewReschedule = ({ userName }) => {
    ...
    <React.Fragment>
      ...
      <div className="course__home__container">
        ...
        <div className="course__home__container__divider">
          ...
          >
            <div className="addcourse__title">Reschedule</div>
            <div className="addcourse__form__container">
              <TeacherAddNewRescheduleForm
                userName={userName}
                courseId={courseId}
              />
            </div>
...
export default TeacherAddNewReschedule;
