...
export default function CourseForumTableRow({ courseForum }) {
  let dataIndex = 0;
  function createData(
    isfinished,
    teacherName,
  ...
  const row = createData(
    courseForum.isfinished,
    courseForum.teachername,
    courseForum.title,
    courseForum.start_time,
    courseForum.topic_description
  );
