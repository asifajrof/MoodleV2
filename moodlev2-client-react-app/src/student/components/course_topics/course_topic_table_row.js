...
export default function CourseTopicTableRow({courseTopic}) {
  let dataIndex = 0;
  function createData(isfinished, teacherName, topicName, startTime, topicDescription) {
    ...
    return { dataIndex, checkBox, teacherName, topicName, startTime, topicDescription};
  }
