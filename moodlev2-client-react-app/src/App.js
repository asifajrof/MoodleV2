...
import TeacherResources from "./teacher/pages/course_resources";
...
import TeacherAddNewResource from "./teacher/pages/TeacherAddNewResource";
				...
				<main>
					<Routes>
						...
						<Route
							...
							element={<TeacherResources userName={token.id} />}
						/>
						<Route
							path={"/course/:courseId/resource/addnew"}
							element={<TeacherAddNewResource userName={token.id} />}
						/>
						<Route
